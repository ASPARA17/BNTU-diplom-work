...
`; $('.table-add').on('click', 'i', () => { const $clone = $tableID.find('tbody tr').last().clone(true).removeClass('hide table-line'); if ($tableID.find('tbody tr').length
...
$tableID.find('tr:not(:hidden)'); const headers = []; const data = [];
 // Get the headers
